...
public class ExpireGuiCommand extends AbstractCommand
{
    public ExpireGuiCommand(BaseCommand base)
    {
        super(base, "expire");
    }
    ...
    public boolean execute(CommandSender sender, CommandArgs args)
    {
        ...
        MenuFactory.openClaim(AuctionHouse.getInstance(), player, ClaimBoxMenu.Mode.EXPIRED);
        return true;
    }
